...
<head>
    ...
    <style>
        ...
        .header { display: flex; justify-content: space-between; align-items: center; padding: 10px; background-color: #ae8b1c; color: white; }
        .header h2 { margin: 0;
            margin: 30px;
        }
    ...
    <tr>
        ...
        <td>
            ...
            <form action="payment.jsp" method="GET">
                ...
                <input type="hidden" name="carModel" value="<%= booking.get("carModel") != null ? booking.get("carModel") : "" %>">  <!-- ✅ Pass Car Model -->
